...
urlpatterns = [
    ...
    url(r'^detailVersion/(?P<id>[0-9a-f-]+)$', versionViews.detail_version, name='detailVersion'),
    url(r'^detailVersion/(?P<id>[0-9a-f-]+)/?(\S)$', versionViews.detail_version, name='detailVersion'),
]
