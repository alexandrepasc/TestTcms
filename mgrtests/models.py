...
class TestCase(models.Model):
    ...
    name = models.CharField(max_length=30)
    description = models.CharField(max_length=100)
    product = models.ForeignKey(Product, related_name='cases', on_delete=models.CASCADE, null=True)
    component = models.ForeignKey(Component, related_name='cases', on_delete=models.CASCADE, null=True)
    tag = models.ForeignKey(Tag, related_name='cases', on_delete=models.CASCADE, null=True)
